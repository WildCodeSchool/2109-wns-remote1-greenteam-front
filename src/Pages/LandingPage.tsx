...
export default function LandingPage(): JSX.Element {
  ...
  <div className="bg-cyan w-full h-screen flex items-center">
    ...
    <div className="w-1/2 flex items-center flex-col justify-center">
      ...
      <div className="px-10">
      <h1 className="text-white text-center text-3xl 2xl:text-5xl xl:leading-normal 2xl:leading-relaxed">Organizing your projects and collaborating with your team have never been so easy</h1>
      </div>
