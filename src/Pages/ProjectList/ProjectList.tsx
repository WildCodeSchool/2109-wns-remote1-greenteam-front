...
export default function ProjectList(): JSX.Element {
  ...
  return (
    <div className=" flex flex-col items-center w-screen h-screen gap-2 p-8">
      ...
      <div className="bg-cyan w-max h-14 object-cover rounded-lg lg:text-sm sm:text-xs md:text-xs text-xs p-0.5 flex box-border">
