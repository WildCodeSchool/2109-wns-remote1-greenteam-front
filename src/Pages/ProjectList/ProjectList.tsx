...
import { activeNextPageButton, imgprojectlist, inactiveNextPageButton, searchIcon } from '../../assets'
...
const arraydata = [{ id: 1, title: "project 1", manager: "John Doe" }, { id: 2, title: "project 2", manager: "John Doe" }, { id: 3, title: "project 3", manager: "John Doe" }, { id: 4, title: "project 4", manager: "John Doe" }, { id: 5, title: "project 5", manager: "John Doe" }, { id: 6, title: "project 6", manager: "John Doe" }
  , { id: 7, title: "project 7", manager: "John Doe" }, { id: 8, title: "project 8", manager: "John Doe" }, { id: 9, title: "project 9", manager: "John Doe" }, { id: 10, title: "project 10", manager: "John Doe" }, { id: 11, title: "project 11", manager: "John Doe" }, { id: 12, title: "project 12", manager: "John Doe" }];
...
export default function ProjectList(): JSX.Element {
  ...
  return <div className=' flex flex-col w-screen h-screen gap-2'>
          ...
          <div className="relative">
            <Listbox.Button className="relative w-full bg-white border border-gray-300 rounded-md shadow-sm pl-3 pr-10 py-2 text-left cursor-default focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
              <span className="flex items-center">
                <span className="mr-6 block truncate">{selected.type}</span>
              </span>
    ...
    <div className='w-full flex flex-row gap-5 p-2 justify-center flex-wrap'>
      {arraydata.map((item) => <div key={item.id}><ProjectBox title={item.title} manager={item.manager} /></div>)}
    </div>
