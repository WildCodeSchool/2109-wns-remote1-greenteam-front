...
export default function HomePage({ name }: HomePageProps): JSX.Element {
  ...
  return (
    ...
    <div className="w-full">
      <h1 className="text-5xl text-center mt-14">Welcome {name} ! Ready to smash your goals?</h1>
    </div>
    
    <div className="flex h-full w-full justify-center items-center">
        <div className='flex flex-row justify-around items-center'>
          {contents.map(({ imgsrc, text }) => <div className='w-1/3 flex flex-col items-center'>
